...
class ScreenFragment : BaseFragment(), View.OnClickListener {
    ...
    private fun getDeviceInfo(): String? {
        ...
        sb.append("\n屏幕宽度：${ScreenUtil.getScreenWidth(mContext)}")
        sb.append("\n屏幕高度：${ScreenUtil.getScreenHeight(mContext)}")
        sb.append("\n屏幕物理尺寸(英寸)：${ScreenUtil.getPhysicsScreenSize(mContext)}")
        sb.append("\n屏幕物理宽度(cm)：${ScreenUtil.getPhysicsScreenWidth(mContext)}")
        sb.append("\n屏幕物理高度(cm)：${ScreenUtil.getPhysicsScreenHeight(mContext)}")
