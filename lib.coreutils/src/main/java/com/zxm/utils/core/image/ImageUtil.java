package com.zxm.utils.core.image;
...
public final class ImageUtil {
     ...
     * @return bytes
     */
    public static byte[] bitmap2Bytes(final Bitmap bitmap, @NonNull final Bitmap.CompressFormat format) {
     ...
     * @return bytes
     */
    public static byte[] drawable2Bytes(final Drawable drawable, @NonNull final Bitmap.CompressFormat format) {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(@NonNull final byte[] data, final int offset) {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(@NonNull final byte[] data,
                                   final int offset,
                                   final int maxWidth,
                                   final int maxHeight) {
        if (data.length == 0) return null;
     ...
     */
    public static Bitmap fastBlur(@NonNull Context context,
                                  final Bitmap src,
                                  @FloatRange(
